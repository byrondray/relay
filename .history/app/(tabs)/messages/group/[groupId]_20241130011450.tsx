...
const styles = StyleSheet.create({
  ...
  camera: { flex: 1 },
  captureButton: { position: "absolute", bottom: 20, alignSelf: "center", backgroundColor: "red", borderRadius: 10, padding: 10 },
  captureButtonText: { color: "white", fontSize: 16 },
  closeButton: { position: "absolute", top: 40, right: 20, backgroundColor: "black", borderRadius: 10, padding: 10 },
  closeButtonText: { color: "white", fontSize: 16 },
  openCameraText: { fontSize: 16, color: "blue", marginRight: 10 },
  capturedImage: { width: "100%", height: 200, marginVertical: 10 },
});
