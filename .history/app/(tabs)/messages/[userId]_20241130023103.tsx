...
export default function MessageScreen() {
  ...
  const sendMessage = async () => {
    ...
    const messageData = {
      text: newMessage,
      imageUri: profileImage, // Include the image URI if there's one
    ...
    try {
      await sendMessageToServer(messageData); // Replace with your function to send the message to your backend or database
