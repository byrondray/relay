...
declare module 'expo-router' {
  export namespace ExpoRouter {
    export interface __routes<T extends string = string> extends Record<string, unknown> {
      StaticRoutes: `/` | `/(tabs)` | `/(tabs)/` | `/(tabs)/Carpool/NewRide` | `/(tabs)/Carpool/createRide` | `/(tabs)/Carpool/postRequest` | `/(tabs)/Carpool/selectPassenger` | `/(tabs)/Carpool/selectPassengerList` | `/(tabs)/Community/community` | `/(tabs)/settings` | `/(tabs)/temp` | `/(tabs)/trips/listcarpool` | `/Carpool/NewRide` | `/Carpool/createRide` | `/Carpool/postRequest` | `/Carpool/selectPassenger` | `/Carpool/selectPassengerList` | `/Community/community` | `/Login/login` | `/OnboardForms/child` | `/OnboardForms/parent` | `/OnboardForms/vehicle` | `/Register/register` | `/_sitemap` | `/settings` | `/temp` | `/theme` | `/trips/listcarpool`;
